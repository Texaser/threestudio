...
@threestudio.register("multiscale_triplane")
class MultiscaleTriplane(BaseImplicitGeometry):
    @dataclass
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, MultiscaleTriplane):
            instance = MultiscaleTriplane(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {MultiscaleTriplane.__name__} from {other.__class__.__name__}"
            )
